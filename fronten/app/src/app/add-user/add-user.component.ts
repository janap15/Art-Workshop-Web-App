      ...
      if (u) {
        ...
        if (this.img != null) {
          this.registerService.registerWithProfileImg(this.username, this.password, this.firstname, this.lastname, this.phone, 
            this.email, this.orgName, this.state, this.city, this.post, this.street, this.number, this.MB, type, "aktivan", this.img).subscribe(res => {
        ...
        this.registerService.register(this.username, this.password, this.firstname, this.lastname, this.phone, 
          this.email, this.orgName, this.state, this.city, this.post, this.street, this.number, this.MB, type, "obrada").subscribe(res => {
            if (res['msg'] != 'ok') alert('error');
          })
        }
